...
public class Clientes extends javax.swing.JDialog {
    ...
    private void preencherTabela() {
        String[] propriedades = {"Id", "Nome", "Cartão", "Cpf", "Cidade","Estado","Bairro","Rua","Numero",};
        ClienteDAO dao = new ClienteDAO();
        List<Cliente> clientes = dao.list();
        String[][] matriz = new String[clientes.size()][9];
        for (int i = 0; i < clientes.size(); i++) {
            Cliente cliente = clientes.get(i);
            matriz[i][0] = cliente.getId() + "";
            matriz[i][1] = cliente.getNome();
            matriz[i][2] = cliente.getCartao() + "";
            matriz[i][3] = cliente.getCpf();
            matriz[i][4] = cliente.getEndereco().getCidade();
            matriz[i][5] = cliente.getEndereco().getEstado();
            matriz[i][6] = cliente.getEndereco().getBairro();
            matriz[i][7] = cliente.getEndereco().getRua();
            matriz[i][8] = cliente.getEndereco().getNumero();
        ...
        if (clientes.size() > 0) {
            tabelaAluno.setModel(model);
            tabelaAluno.setRowSorter(sorter);
        } else {
            tabelaAluno.setModel(model);
            tabelaAluno.setRowSorter(null);
        }
    ...
    private void initComponents() {
        ...
        labelBuscarProfessor.setText("Buscar Aluno:");
    ...
    private void botaoAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAdicionarActionPerformed
        AddCliente view = new AddCliente(null, true);
        view.setVisible(true);
    }//GEN-LAST:event_botaoAdicionarActionPerformed

    private void botaoRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoRemoverActionPerformed
        ClienteDAO dao = new ClienteDAO();
        int resposta = JOptionPane.showConfirmDialog(null, "Voce tem certeza que deseja excluir o aluno selecionado?", "?", JOptionPane.YES_NO_OPTION);
        if (resposta == 0) {
            Long id = Long.valueOf((String) tabelaAluno.getModel().getValueAt(tabelaAluno.getSelectedRow(), 0));
            dao.remove(dao.getClienteById(id));
        }
    ...
    private void botaoEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEditarActionPerformed
        ClienteDAO dao = new ClienteDAO();
        Long id = Long.valueOf((String) tabelaAluno.getModel().getValueAt(tabelaAluno.getSelectedRow(), 0));
        AddCliente view = new AddCliente(null, true, dao.getClienteById(id));
        view.setVisible(true);
